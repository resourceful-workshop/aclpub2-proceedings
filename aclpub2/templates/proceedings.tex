...
\begin{titlepage}
  ...
  \backgroundsetup{
            contents={\includegraphics{/Users/xilini/aclpub2_proceedings/resourceful-2023/prefaces/coversmall.jpg}}
        }
  
  \begin{center}
    \vspace{1.5cm}

    {\LARGE \textcolor{white}{\VAR{conference.anthology_venue_id} \VAR{conference.start_date.year}}}
  ...
  \BLOCK{for logo_batched in tier.logos|batch(4)}
    \BLOCK{for logo in logo_batched}
      \begin{minipage}[c][0.21\linewidth][c]{0.21\linewidth}
        \includegraphics[width=2.5\linewidth]{\VAR{root}/sponsor_logos/\VAR{logo}}
